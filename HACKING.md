...
hidden if the `atomic-potentials_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `atomic-potentials_DEVELOPER_MODE` to the configure
